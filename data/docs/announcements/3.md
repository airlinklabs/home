...
<(flow title="HMAC request flow" steps="Panel:Build request (method,path,body),Panel:Generate timestamp+nonce,Panel:Sign with HMAC-SHA256,Panel:Send request+headers,Daemon:Check IP allowlist,Daemon:Verify Basic Auth,Daemon:Recompute HMAC,Daemon:Compare signature,Daemon:Check nonce set,Daemon:Execute or reject,Panel:Return JSON response")>
