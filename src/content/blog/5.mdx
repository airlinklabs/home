...
flowchart TD
    A["Panel: Scan storage/addons/"] --> B["Panel: Read package.json"]
    B --> C["Panel: Run migrations"]
    C --> D["Panel: Import entry point"]
    D --> E["Addon: Register routes"]
    E --> F["Addon: Register sidebar items"]
    ...
    style D fill:#1e40af,stroke:#3b82f6,color:#e0e0e0,stroke-width:2px
    style E fill:#065f46,stroke:#10b981,color:#e0e0e0,stroke-width:2px
    style F fill:#065f46,stroke:#10b981,color:#e0e0e0,stroke-width:2px
```
